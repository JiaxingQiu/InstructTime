...
# # Train Data
# df = pd.read_excel('../../data_raw/nicu/PAS Challenge HR Data.xlsx', engine="calamine")
...
# df_y = pd.read_excel('../../data_raw/nicu/PAS Challenge Outcome Data.xlsx', engine="calamine")[['VitalID', 'DiedNICU', 'DeathAge']]
# df_demo = pd.read_excel('../../data_raw/nicu/PAS Challenge Demographic Data.xlsx', engine="calamine")
# df_x = pd.read_excel('../../data_raw/nicu/PAS Challenge Model Data.xlsx', engine="calamine")
...
# # # Test Data
# # df_y_test = pd.read_excel('../../data_raw/nicu/Test Data/Test Demographic Key.xlsx', sheet_name=0, engine="calamine")
# # df_test = pd.read_excel('../../data_raw/nicu/Test Data/Test HR Data.xlsx', sheet_name=0, engine="calamine") # test hr with description
...
# # df_demo_test = pd.read_excel('../../data_raw/nicu/Test Data/Test Demographic Data.xlsx', sheet_name=0, engine="calamine")
...
# df_train.to_csv('../../data/nicu/train.csv.zip', compression='zip', index=False)
# df_test.to_csv('../../data/nicu/test.csv.zip', compression='zip', index=False)
# df_left.to_csv('../../data/nicu/left.csv.zip', compression='zip', index=False)
