...
def main(args):
    ...
    ROOT = Path(__file__).resolve().parent.parent.parent  # Go up from script/tedit_lite/main.py to project root
    tedit_path = ROOT / "script" / "tedit_lite"
